...
namespace sharpRPA.Core.AutomationCommands
{
  ...
  /*  [Serializable]
    ...
    [Attributes.ClassAttributes.Description("Эта команда позволяет вам открыть приложение Excel.")]
    [Attributes.ClassAttributes.ImplementationDescription("Эта команда реализует взаимодействие с Excel для автоматизации.")]
